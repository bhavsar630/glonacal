		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('upload.php', dataArray[index], function(data) {
				...
				if(totalPercent*(x) == 100) {
					...
					//$('#loading-content').html('Uploading Complete!'); //commented by parth - as currently don't need it
					...
					//$('#loading-content').html('Uploading '+fileName); //commented by parth - as currently don't need it
